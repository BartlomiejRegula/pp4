...
public class SqlTest {
    ...
    @BeforeEach
    void setupDb(){
        jdbcTemplate.execute("DROP TABLE `product_catalog__products` IF EXIST");
        var sql = """
    ...
    void itInsertElement(){
        ...
        var sql = """
                ...
                VALUES
                    ...
                    ('18abcc02e4b', 'example product Y', "nice one", 20.20);
                """;
        jdbcTemplate.execute(sql);
    ...
    void itSelectAll(){
        ...
        List<Map<String, Object>> maps = jdbcTemplate.queryForList("Select * from `product_catalog__product`");
